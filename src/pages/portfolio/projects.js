        ...
        projects: [
            {
                ...
                description:
                    "A bilingual informative website optimized for performance and SEO, delivered under Nourseen. Implemented responsive design and localization to deliver a seamless user experience across languages and devices.",
            ...
            },
            {
                ...
                description:
                    "A bilingual informative website optimized for performance and SEO, delivered under Nourseen. Implemented responsive design and localization to deliver a seamless user experience across languages and devices. Delivered as part of my role at Tjaara.",
            ...
            },
            {
                ...
                description:
                    "3D T-Shirt customization tool allowing users to design and preview t-shirts with personalized text, logos, and colors.o Implemented real-time rendering using Three.js + React Three Fiber for a smooth user experience",
            ...
            },
            {
                ...
                description:
                    "The website is built using React, and it employs state management with useState and useEffect. This is also the first time the project incorporates styled-components for styling and Firebase for data management.",
            ...
            },
            {
                ...
                description:
                    "World Organization for Medical Services (WOMS) website, built with React. This project aims to provide an efficient and effective online platform for doctors and medical professionals.",
            ...
            },
            {
                ...
                description:
                    "Multi-language support (Arabic, English, Russian) using i18n Responsive design Various business services including translation, liquidation, visa, and business setup",
